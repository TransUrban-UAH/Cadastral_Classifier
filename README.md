# Cadastral Classifier: a QGIS plugin to classify Spamish municipalities using cadastral information ![plugin icon](https://github.com/TransUrban-UAH/Cadastral_Classifier/blob/main/icon.jpg)
